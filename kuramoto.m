...
OrderParam[graphs_, alpha_,lambda_,sigma_,K_,maxtime_,npaths_,nsteps_,seed_:3133]:= Module[{}, Export["graphs.g6",graphs];
...
data`Alpha1 = 
  Table[OrderParam[glist, alpha, 0.1, 0.3, 1000, maxTime, numPaths, 
    numSteps], {alpha, {0.1, 0.5, 0.9, 0.95, 1.05, 1.1, 1.5, 1.99}}];

Print["."];

data`Alpha2 = 
  Table[OrderParam[glist, alpha, 0.1, 0.6, 1000, maxTime, numPaths, 
    numSteps], {alpha, {0.1, 0.5, 0.9, 0.95, 1.05, 1.1, 1.5, 1.99}}];
