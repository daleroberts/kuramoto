...
public:
  ...
  Statistics(size_t sample_number, double sample_weight, double sum, double quadratic_sum,
             double cubic_sum, double fourth_power_sum, double min, double max)
      : sample_number_(sample_number), sample_weight_(sample_weight), sum_(sum),
        quadratic_sum_(quadratic_sum), cubic_sum_(cubic_sum), fourth_power_sum_(fourth_power_sum),
        min_(min), max_(max) {}
